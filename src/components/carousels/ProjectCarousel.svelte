<script>
	...
	const next = () => (currentProjectIndex = calcIndex('next'));

	const prev = () => (currentProjectIndex = calcIndex('prev'));
...
<div class="section center">
	<div class="index-display">
		<span class="green-text text-darken 2 text-large"
			>{currentProjectIndex + 1} / {projects.length}</span
		>
	</div>
</div>
